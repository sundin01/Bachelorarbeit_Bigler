...
through all locations and redo all analysis.

## Read packages

This code chunk loads all packages you need. If you have not installed any
package, it will install it by itself.
...
Here, we read all digitized data sets from the ERACLIM project. For a
...
data sets were not considered in the analyisis:
...
Here, we transform coordinates in the WGS84 system, because it is easier to
handle. For that, we wrote a function on a R-script.
...
locations of the volcaenos or drill hole for the ice cores:
