...
```{r open_washington}
file.edit('../vignettes/Washington.Rmd')
```
...
```{r open_mt.wilson}
file.edit('../vignettes/Mt.Wilson.Rmd')
```
...
file.edit('../vignettes/Hump_Mountain.Rmd')
```
...
```{r open_calama}
file.edit('../vignettes/Calama.Rmd')
```
...
```{r open_haraqua_hala}
file.edit('../vignettes/Haraqua_Hala.Rmd')
```
...
```{r open_montezuma}
file.edit('../vignettes/Montezuma.Rmd')
```
...
file.edit('../vignettes/Table_Mountain.Rmd')
```
...
```{r open_Mt.Brukkaros}
file.edit('../vignettes/Mt_Brukkaros.Rmd')
```
