...
levels = c("400", "450", "500", "600", "700", "800", "900", "1000", "1200", "1600")))|>
drop_na()|>
ggplot()+
geom_point(aes(x = Date, y = values, color = variable)) +
labs(x = 'Date', y = 'Transmittance [%]') +
...
source("../R/General/packages.R")
source("../Bachelorarbeit/R/General/packages.R")
source("../Bachelorarbeit/R/General/read_data.R")
source("../Bachelorarbeit/R/General/read_data.R")
source("../Bachelorarbeit/R/General/read_data.R")
source("../Bachelorarbeit/R/General/read_data.R")
source("../Bachelorarbeit/R/General/read_data.R")
# Change in Transmittance data during katmai eruption
...
values_to = 'values')|>
dplyr::mutate(variable = factor(variable,
levels = c("350", "400", "450", "500", "600", "700", "800", "1000", "1200", "1600")))|>
...
geom_jitter(aes(x = variable, y = values), size = .5, width = .1,
alpha = .1)+
labs(x = 'Wavelength [nm]', y = 'Transmittance [%]') +
theme_light() +
theme(panel.border = element_rect(colour = "black", fill = NA, linewidth = 1))
Mt.Wilson.1905.1920|>
dplyr::filter(lambda1...m.== 0.35)
View(Bassour.1911.1912)
Bassour.1911.1912|>
dplyr::mutate('Date' = lubridate::ymd(paste(Mt.Wilson.1905.1920$year,
Mt.Wilson.1905.1920$month,
Mt.Wilson.1905.1920$day,
...
theme(panel.border = element_rect(colour = "black", fill = NA, linewidth = 1))
View(df.locations)
View(Harqua_Hala.1920.1925)
View(Montezuma.1920.1930)
