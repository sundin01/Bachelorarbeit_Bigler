...
write_csv(Mt.Brukkaros.1926.1930, '../../data/trans_Timeline/Mt.Brukkaros.ok.csv')
```
...
################################################################################
transmission <- Mt.Brukkaros_long|>
...
################################################################################
trans_annual_mean <- Mt.Brukkaros_long|>
   dplyr::mutate(month = lubridate::month(Date, label = TRUE)) |> 
   dplyr::mutate(variable = factor(variable,
                levels = c("trans_349", "trans_395", "trans_450", 
                           "trans_499", "trans_621", "trans_714", "trans_803",
...
optical_depth <- Mt.Brukkaros_od|>
  ...
  dplyr::filter(variable == 'trans_349' | variable == 'trans_395' | variable == 'trans_450' |
                  variable == 'trans_621' | variable == 'trans_714' | variable == 'trans_1593')
################################################################################
od_annual_mean <- Mt.Brukkaros_od|>
   dplyr::mutate(month = lubridate::month(Date, label = TRUE)) |> 
   dplyr::mutate(variable = factor(variable,
                levels = c("trans_349", "trans_395", "trans_450", 
                           "trans_499", "trans_621", "trans_714", "trans_803",
...
write_csv(od_annual_mean, '../../data/od_Timeline/Mt.Brukkaros.od.csv')
################################################################################
# Ågström parameter
################################################################################
Mt.Brukkaros.alpha.long <- Mt.Brukkaros|>
  dplyr::mutate(alpha_350 = -(log(Mt.Brukkaros$trans_349) - log(Mt.Brukkaros$trans_977)) / log(349),
    alpha_400 = -(log(Mt.Brukkaros$trans_395) - log(Mt.Brukkaros$trans_977)) / log(395),
    alpha_450 = -(log(Mt.Brukkaros$trans_450) - log(Mt.Brukkaros$trans_977)) / log(450),
    alpha_500 = -(log(Mt.Brukkaros$trans_499) - log(Mt.Brukkaros$trans_977)) / log(499),
    alpha_600 = -(log(Mt.Brukkaros$trans_621) - log(Mt.Brukkaros$trans_977)) / log(621),
    alpha_700 = -(log(Mt.Brukkaros$trans_714) - log(Mt.Brukkaros$trans_977)) / log(714),
    alpha_800 = -(log(Mt.Brukkaros$trans_803) - log(Mt.Brukkaros$trans_977)) / log(803),
    alpha_900 = NA,
    alpha_1200 = -(log(Mt.Brukkaros$trans_1214) - log(Mt.Brukkaros$trans_977)) / log(1214),
    alpha_1600 = -(log(Mt.Brukkaros$trans_1593) - log(Mt.Brukkaros$trans_977)) / log(1593)) |>
...
################################################################################
alpha_annual_mean <- Mt.Brukkaros.alpha.long|>
   dplyr::mutate(month = lubridate::month(Date, label = TRUE)) |> 
   dplyr::mutate(variable = factor(variable,
                levels = c("alpha_350", "alpha_400", "alpha_450", "alpha_500", 
                           "alpha_600", "alpha_700", "alpha_800", "alpha_900",
...
write_csv(alpha_annual_mean, '../../data/alpha_timeline/Mt.Brukkaros.alpha.csv')
```
