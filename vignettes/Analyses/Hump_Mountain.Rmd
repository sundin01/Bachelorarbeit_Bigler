...
Hump_Mountain_long <- Hump_Mountain|>
  ...
  dplyr::mutate('lambda' = rep(c('349', '395', '450', '499', '621', 
                                 '714','803', '977', '1214', '1593'), times = 58))|>
...
################################################################################
trans_annual_mean <- Hump_Mountain|>
...
Hump_Mountain.alpha <- Hump_Mountain|>
  dplyr::mutate(
    alpha_349 = -(log(Hump_Mountain$trans_349) - log(Hump_Mountain$trans_977)) / log(349),
    alpha_395 = -(log(Hump_Mountain$trans_395) - log(Hump_Mountain$trans_977)) / log(395),
    alpha_450 = -(log(Hump_Mountain$trans_450) - log(Hump_Mountain$trans_977)) / log(450),
    alpha_499 = -(log(Hump_Mountain$trans_499) - log(Hump_Mountain$trans_977)) / log(499),
    alpha_621 = -(log(Hump_Mountain$trans_621) - log(Hump_Mountain$trans_977)) / log(621),
    alpha_714 = -(log(Hump_Mountain$trans_714) - log(Hump_Mountain$trans_977)) / log(714),
    alpha_803 = -(log(Hump_Mountain$trans_803) - log(Hump_Mountain$trans_977)) / log(803),
    alpha_1214 = -(log(Hump_Mountain$trans_1214) - log(Hump_Mountain$trans_977)) / log(1214),
    alpha_1593 = -(log(Hump_Mountain$trans_1593) - log(Hump_Mountain$trans_977)) / log(1593)) |>
...
################################################################################
alpha_annual_mean <- Hump_Mountain.alpha|>
  group_by(month = lubridate::floor_date(Date, 'year'))|>
