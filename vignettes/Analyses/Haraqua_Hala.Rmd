...
Haraqua_Hala_long <- Haraqua_Hala|>
  ...
  dplyr::mutate('lambda' = rep(c('349', '395', '450', '499', '621', 
                                 '714','803', '977', '1214', '1593'), times = 226))|>
...
################################################################################
trans_annual_mean <- Haraqua_Hala|>
...
Haraqua_Hala.alpha <- Haraqua_Hala|>
  dplyr::mutate(
    alpha_349 = -(log(Haraqua_Hala$trans_349) - log(Haraqua_Hala$trans_977)) / log(349),
    alpha_395 = -(log(Haraqua_Hala$trans_395) - log(Haraqua_Hala$trans_977)) / log(395),
    alpha_450 = -(log(Haraqua_Hala$trans_450) - log(Haraqua_Hala$trans_977)) / log(450),
    alpha_499 = -(log(Haraqua_Hala$trans_499) - log(Haraqua_Hala$trans_977)) / log(499),
    alpha_621 = -(log(Haraqua_Hala$trans_621) - log(Haraqua_Hala$trans_977)) / log(621),
    alpha_714 = -(log(Haraqua_Hala$trans_714) - log(Haraqua_Hala$trans_977)) / log(714),
    alpha_803 = -(log(Haraqua_Hala$trans_803) - log(Haraqua_Hala$trans_977)) / log(803),
    alpha_1214 = -(log(Haraqua_Hala$trans_1214) - log(Haraqua_Hala$trans_977)) / log(1214),
    alpha_1593 = -(log(Haraqua_Hala$trans_1593) - log(Haraqua_Hala$trans_977)) / log(1593)) |>
...
################################################################################
alpha_annual_mean <- Haraqua_Hala.alpha|>
  group_by(month = lubridate::floor_date(Date, 'year'))|>
...
annual_alpha <- alpha_annual_mean|>
  ...
  annotate("text", x = as.Date("1924-02-15", format = '%Y-%m-%d'),
  y = .2, label= "Raikoke [1924-02-15]", hjust = 1, vjust = -0.2,angle = 90,alpha = 0.5) +
  labs(x = 'Time [1920 - 1925]', y = 'Annual mean of the Ångström parameter [ ]') +
  scale_y_continuous(limits = c(-.05, .2)) +
  scale_color_viridis_d(option = "viridis",
